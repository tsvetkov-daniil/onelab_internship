...
class AuthControllerTest {
    ...
    @Autowired
    AuthControllerTest(TestRestTemplate restTemplate, ReaderRepository readerRepository, RoleRepository roleRepository) {
    ...
    void testCreateReader() {
        ...
        Assertions.assertThat(response.getBody().getRole()).isNotNull();
    }
