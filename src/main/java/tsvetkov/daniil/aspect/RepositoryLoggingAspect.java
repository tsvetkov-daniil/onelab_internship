...
public class RepositoryLoggingAspect {
    ...
    @Pointcut("execution(* tsvetkov.daniil.repository.*.*(..))")
    public void repositoryMethods() {}

    @Pointcut("execution(* tsvetkov.daniil.repository.BookRepository.findAuthorsByBookId(..))")
    public void repositoryMethodsException() {}

    @Pointcut("execution(* tsvetkov.daniil.repository.*.*(..)) && args(..)")
